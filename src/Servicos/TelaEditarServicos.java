...
public class TelaEditarServicos {
	...
	public String EditandoNomes(char opcao) {
		...
		case 'A':
			...
			System.out.println(
					"                 * ***************************************************************************** *");
			System.out.println(
					"                 * *                           PROJETO ESCALA SERVICO                          * *");
			System.out.println(
					"                 * *                                                                           * *");
			System.out.println(
					"                 * *                                                                           * *");
			System.out.println(
					"                                              DIGITE O NOME DA ESCALA A                           ");
			System.out.println(
					"                 * *                                                                           * *");
			System.out.println(
					"                 * *                                                                           * *");
	...
	public char EditarNomesACD() {
		...
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                           			  		    ESCALA C (" + EscalaC.getNome() + ")             ");
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                         			  		    ESCALA D (" + EscalaD.getNome() + ")              ");
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                 * *                                                                           * *");
	...
	public char EditarNomesABD() {
		...
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                            				    ESCALA A (" + EscalaA.getNome() + ")              ");
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                           			  		    ESCALA B (" + EscalaB.getNome() + ")             ");
		System.out.println(
				"                 * *                                                                           * *");
		System.out.println(
				"                         			  		    ESCALA D (" + EscalaD.getNome() + ")             ");
